        ...
        if (response.data.data.media_gallery.data.length > 0) {
            response.data.data.media_gallery.data.map((item) => {
                html += `<div class="col-md-3">
                                    <div class="preview-image-container">
                                        <div class="preview-image-container-action">
                                            <button type="button" data-photo-id="${item.id}" data-photo-name="${item.photo_name}" data-photo-url="${item.photo}" class="btn btn-sm btn-secondary media-library-image-select"><i class="fa-solid fa-check"></i></button>
                                            <button type="button" data-photo-id="${item.id}" data-photo-name="${item.photo_name}" data-photo-url="${item.photo}" class="btn btn-sm btn-secondary mx-1 media-library-image-large-preview"><i class="fa-solid fa-eye"></i></button>
                                            <button type="button" data-photo-id="${item.id}" data-photo-name="${item.photo_name}" data-photo-url="${item.photo}" class="btn btn-sm btn-secondary media-library-image-delete"><i class="fa-solid fa-trash"></i></button>
                                        </div>
