...
{{ html()->form('GET', route('blog-category.index'))->id('search_form')->open() }}
...
<div class="row justify-content-center mb-4 align-items-end">
    ...
    <div class="col-md-3 mb-4">
        {{html()->select('status', \App\Models\BlogCategory::STATUS_LIST, $search['status'] ?? null)->class('form-select')->placeholder(trans('Select Status'))}}
    </div>
    <div class="col-md-3 mb-4">
