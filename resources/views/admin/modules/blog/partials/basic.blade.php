<div class="row align-items-center justify-content-center">
    <div class="col-md-12 mb-4">
        <div class="custom-form-group">
            {{ html()->label(__('Blog Title'))->for('title') }}
            <x-required />
            {{ html()->text('title')->class('make-slug meta-title form-control ' . ($errors->has('title') ? 'is-invalid' : ''))->placeholder(__('Enter Blog Title') ) }}
    ...
    <div class="col-md-12 mb-4">
        <div class="custom-form-group">
            ...
            <x-required />
            {{ html()->select('categories[]', $categories, old('categories') ?? (isset($blog) ? $blog->categories->pluck('id') : null))->class('form-select select2 ' . ($errors->has('categories') ? 'is-invalid' : ''))->multiple() }}
    ...
    <div class="col-md-6 mb-4">
        <div class="custom-form-group">
           ...
           {{ html()->date('start_date')->class('form-control ' . ($errors->has('start_date') ? 'is-invalid' : ''))->placeholder(__('Enter Start Date')) }}
    ...
    <div class="col-md-6 mb-4">
        <div class="custom-form-group">
            ...
            {{ html()->date('end_date')->class('form-control ' . ($errors->has('end_date') ? 'is-invalid' : ''))->placeholder(__('Enter End Date')) }}
